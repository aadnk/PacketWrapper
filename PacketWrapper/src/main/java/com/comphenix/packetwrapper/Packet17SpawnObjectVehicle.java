...
public class Packet17SpawnObjectVehicle extends AbstractPacket {
    ...
    private static PacketContainer fromEntity(Entity entity, int type, int objectData) {
        if (entityConstructor == null)
        	entityConstructor = ProtocolLibrary.getProtocolManager().createPacketConstructor(ID, entity, type, objectData);
