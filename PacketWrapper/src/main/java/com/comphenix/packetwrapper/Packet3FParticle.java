...
public class Packet3FParticle extends AbstractPacket {
     ...
     */
    public Packet3FParticle(PacketContainer packet) {
        super(packet, ID);
    }
     ...
     */
    public Packet3FParticle(ParticleEffect effect, int count, Location location, Vector offset) {
    	this();
